...
urlpatterns = [
    # path('kugou/<str:song_id>/', views_save.kugou_url, name='kugou_url'),
    ...
    path("audio/<str:song_id>", views.get_stream),
    path("cover/<str:song_id>", views.get_cover),
    path("lrc/<str:song_id>", views.get_lrc),
]
